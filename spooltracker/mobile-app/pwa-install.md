...
2. Tap the **Share** button ⬆️ at the bottom of the screen. Depending on your settings, it could be found at the top of your screen.
   ...
   <img src="./images/pwainstall/ios/click_share_button.jpeg" width="200" alt="Screenshot of Safari address bar highlighting the Share button">

3. Scroll down in the share sheet and tap **Add to Home Screen** ➕.

   <img src="./images/pwainstall/ios/Add_to_home_screen.jpeg" width="200" alt="Screenshot of the iOS share sheet highlighting Add to Home Screen">

4. Tap **Add** ✓ in the top-right corner to confirm.

   <img src="./images/pwainstall/ios/confirm_add_to_home_screen.jpeg" width="200" alt="Screenshot of the Add to Home Screen confirmation dialog highlighting the Add button">

5. The Spooltracker icon will now appear on your **home screen** 🏠. Tap it to launch the app.

   <img src="./images/pwainstall/ios/Added_to_home_screen.jpeg" width="200" alt="Placeholder: screenshot of iOS home screen showing the Spooltracker icon">
...
1. In Chrome, Navigate to https://spooltracker.victaulic.com/app
    ...
    <img src="./images/pwainstall/android_chrome/navigate_to_url.jpg" width="200" alt="Screenshot with url">

2. Tap the **menu** ⋮ button in the top-right of the address bar.

   <img src="./images/pwainstall/android_chrome/three_dots.jpg" width="200" alt="screenshot of Chrome Android with the three-dot menu highlighted">

3. Tap **Install app** ⬇️ (or **Add to Home screen** ➕ on older versions).

   <img src="./images/pwainstall/android_chrome/add_to_home_screen.jpg" width="200" alt="screenshot of Chrome menu showing the Install app option">

4. Tap **Install** ✓ in the popup to confirm.

   <img src="./images/pwainstall/android_chrome/install_prompt.jpg" width="200" alt="screenshot of the install confirmation popup">

5. Tap **Install** again to confirm the installation.

    <img src="./images/pwainstall/android_chrome/confirm_install.jpg" width="200" alt=" screenshot of the install confirmation popup">

6. The Spooltracker icon will now appear on your **home screen** 🏠.

   <img src="./images/pwainstall/android_chrome/home_screen.jpg" width="200" alt="Placeholder: screenshot of Android home screen showing the Spooltracker icon">
...
1. Navigate to https://spooltracker.victaulic.com/app
    ...
    <img src="./images/pwainstall/desktop_chrome/navigate_to_url.png" width="600" alt="screenshot with url">

2. Click the **install** icon ⬇️ in the address bar.

   <img src="./images/pwainstall/desktop_chrome/install_button.png" width="600" alt="screenshot of Chrome desktop address bar highlighting the install icon">

3. Click **Install** ✓ in the popup.

   <img src="./images/pwainstall/desktop_chrome/confirm_install.png" width="600" alt="screenshot of the install confirmation popup">
...
4. The app will open in its own **window** ↗️ and be available from your applications list. You may click on the icon from your desktop to quickly access the application without having to open a browser first.
   ...
   <img src="./images/pwainstall/desktop_chrome/added_to_homescreen.png" width="600" alt="Placeholder: screenshot of Spooltracker running in its own window">
